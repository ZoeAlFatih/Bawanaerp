													...
													<div class="message-container">
														<div id="id-message-list-navbar" class="message-navbar clearfix">
															<div class="message-bar">
																<div class="message-infobar" id="id-message-infobar">
																	<span class="blue bigger-150">Junk Message</span>
																</div>
														...
														<div class="message-list-container">
															<div class="message-list" id="message-list">
																<?php foreach ($junks as $junk):?>
																<div class="message-item">
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"></span>
																	</label>
																	<span class="sender" title="<?php echo $junk['from'];?>"><?php echo $junk['from'];?> </span>
																	<span class="time"><?php echo date('j F Y, g:i a',strtotime($junk['date']));?></span>

																	<span class="summary">
																		<span class="text">
																			<?php echo $junk['subject'];?>
																		</span>
																	</span>
																</div>
																<?php endforeach;?>
														...
														<div class="message-footer clearfix">
															<div class="pull-left"> <?php echo $countJunkMessages;?> junk messages total </div>
														</div>
													</div>
												</div>
											</div><!-- /.tab-content -->
