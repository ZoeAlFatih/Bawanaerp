												...
												<div id="inbox" class="tab-pane in active">
													<div class="message-container">
														...
														<div class="message-list-container">
															<div class="message-list" id="message-list">
																...
																<div class="message-item">
																	...
																	<span class="sender" title="<?php echo $sent['from'];?>"><?php echo $sent['from'];?> </span>
																	<span class="time"><?php echo date('j F Y, g:i a',strtotime($sent['date']));?></span>
														...
														<div class="message-footer clearfix">
															<div class="pull-left"> <?php echo $countSentMessages;?> sent messages total </div>
														</div>
													</div>
												</div>
											</div><!-- /.tab-content -->
