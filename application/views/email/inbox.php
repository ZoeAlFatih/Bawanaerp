													...
													<div class="message-container">
														<div id="id-message-list-navbar" class="message-navbar clearfix">
															<div class="message-bar">
																<div class="message-infobar" id="id-message-infobar">
																	...
																	<span class="grey bigger-110">(<?php echo $UnreadMassages;?> unread messages)</span>
																</div>
														...
														<div class="message-list-container">
															<div class="message-list" id="message-list">
																...
																<div <?php echo $email['unread'] == 1 ? 'class="message-item message-unread"' : 'class="message-item"'; ?>>
																	<label class="inline">
																		<input type="checkbox" class="ace" />
																		<span class="lbl"></span>
																	</label>
																	<span class="sender" title="<?php echo $email['from'];?>"><?php echo $email['from'];?> </span>
																	<span class="time"><?php echo date('j F Y, g:i a',strtotime($email['date']));?></span>
														...
														<div class="message-footer clearfix">
															<div class="pull-left"> <?php echo $countMessages;?> messages total </div>
														</div>
													</div>
												</div>
											</div><!-- /.tab-content -->
